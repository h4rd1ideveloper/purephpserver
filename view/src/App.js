...
import { Form, Container, Header, Col, Row, HeaderList, FeedbackList, Progress } from './components/';
import Store, { Context } from './store';
import { updateProgress } from './lib/helpers/index';
import axios from 'axios';
function App() {
    const [{ isLoaded, toVerify },] = useContext(Context)
    useEffect(
        function () {
