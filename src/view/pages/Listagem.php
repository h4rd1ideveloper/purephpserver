        ...
        <form class="mt-5 container text-black-50">
            <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <input id="nomecpf" type="text" class="form-control form-control-sm"
            ...
            <div class="form-group row">
                <div class="col-2">
                    ...
                    <input class="form-control form-control-sm" dataformatas="" id="start" type="date"
                           value="2011-08-19">
                </div>
                <div class="col-2">
                ...
                <div class="col-2">
                    ...
                    <input class="form-control form-control-sm" dataformatas="" id="vencimento" type="date"
                           value="2011-08-19">
                </div>
    ...
    <script>
        (
            ()=>$('document').ready(function () {
                ...
                /**
                 * const cpfcnpj = 'a.CPFCNPJ = ' + ''; //document.getElementById('ComboBox1').value;
