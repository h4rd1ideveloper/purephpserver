...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="dashboard_3.php" class="nav-link">Home</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<?= $baseUrl; ?>/src/pages/dist/img/user1-128x128.jpg" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<?= $baseUrl; ?>/src/pages/dist/img/user8-128x128.jpg" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<?= $baseUrl; ?>/src/pages/dist/img/user3-128x128.jpg" alt="User Avatar"
                                 class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="dashboard_3.php" class="brand-link">
            <img src="<?= $baseUrl; ?>/src/pages/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?= $baseUrl; ?>/src/pages/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <img class="direct-chat-img"
                                             src="<?= $baseUrl; ?>/src/pages/dist/img/user1-128x128.jpg"
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-infos -->
                                        <img class="direct-chat-img"
                                             src="<?= $baseUrl; ?>/src/pages/dist/img/user3-128x128.jpg"
                                             alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="<?= $baseUrl; ?>/src/pages/dist/img/user7-128x128.jpg">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="<?= $baseUrl; ?>/src/pages/dist/img/user5-128x128.jpg">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="<?= $baseUrl; ?>/src/pages/dist/img/user6-128x128.jpg">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="<?= $baseUrl; ?>/src/pages/dist/img/user8-128x128.jpg">
