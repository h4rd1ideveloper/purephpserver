...
<div id="Authenticate" class="container">
    <div class="row">
        <form id="login" method="post" action="<?= Helpers::baseURL('login') ?>" class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto bg-white p-5 shadow">
            <fieldset class="mb-5">
            ...
            <div class="d-flex flex-row align-items-center justify-content-between  mx-auto text-white-50">
                ...
                <a id="toSign" type="button" role="button" class="btn btn-link  btn-block btn-dark  m-0 mx-1  w-25">Sign</a>
            </div>
        </form>
        <form id="sign" method="post" action="<?= Helpers::baseURL('sign') ?>" class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto bg-white p-5 shadow d-none">
            <fieldset class="mb-5">
                <legend class="text-capitalize text-center mb-4">
                    <h1>authentication</h1>
                </legend>
