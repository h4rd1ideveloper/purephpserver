...
class HttpHelper extends Helpers
{
     ...
     *
     * This function accepts a string or {@see UriInterface} and
     ...
     * @return array
     */
    public static function getBodyByMethod(ServerRequest $request)
    {
        switch (strtolower($request->getMethod())) {
            ...
            {
                try {
                    return self::jsonToArray($request->getBody()->getContents());
                } catch (Exception $e) {
                    return [];
                }
            }
